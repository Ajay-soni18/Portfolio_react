...
const Navbar = ({ darkMode, setDarkMode }) => {
  ...
  return (
    <nav className="fixed top-0 w-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm z-50 shadow-sm transition-colors duration-200">
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white dark:bg-gray-800 transition-colors duration-200">
            {navItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
